...
\lfoot{\footnotesize{The {\LaTeX} code to reproduce the curriculum vitae is available at: \url{https://github.com/sbissantz/smip_application/}.}}
...
%{\raggedright\textbf{Measurement \& Replicability in The Sciences -- A metascientific investigations in the role of measurement when replicating em\-pir\-i\-cal findings}\par}

\medskip % Vertical whitespace
In particular, my research focuses on how (a) modifying validated item-based
measurements or (b) the use of unvalidated scales affects the replicability of
empirical findings. Despite that, I am interessted in predicting replication
success with machine learning models.
...
\jobentry
	{Oct 2021 -- present} 
	{} 
	{RPTU Kaiserslautern-Landau \hfill{\footnotesize{\textsc{(Prof. Dr. Eunike Wetzel)}}}}
...
\jobentry
	...
	\hfill\footnotesize{\textsc{(SMiP)}}}
	{Associate Member of the DFG Research Training Group}
	%{At the OSC, we promote the implementation of open science practices.}

\jobentry
	{Jan 2022 -- present} 
	{}
	{RPTU Open Science Commission \hfill\footnotesize{\textsc{(OSC)}}}
	{Member and vice chairman, since 2023}  
	%{At the OSC, we promote the implementation of open science practices.}
...
\begin{supertabular}{r l}
	...
	\tableentry{2021, 2022 (ws)}{Test theory \& assessment \hspace{0.3cm}\hfill \textsc{\footnotesize{(exercise)}}}{spaceafter}
	
	\tableentry{2022 (ws)}{Data analysis in R \hfill \textsc{\footnotesize{(exercise)}}}{spaceafter}
	
	\tableentry{2022, 2023 (ss)}{Test theory \& asssesment \hfill \textsc{\footnotesize{(seminar)}}}{spaceafter}
...
\begin{supertabular}{r l}
	...
	\tableentry{Miscellaneous}{\LaTeX, Git, Vim \& Emacs}{spaceafter}
...
Psychological Assessment, and Psychological Methods} at the RPTU
...
% \subsection{Bayesian Data Analysis \& Machine Learning}
% How to maximize information entropy using Bayesian updating
