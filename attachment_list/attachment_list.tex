...
\lfoot{\footnotesize{The {\LaTeX} code to reproduce the attachment list is available at: \url{https://github.com/sbissantz/smip_application}.}}
...
\begin{enumerate}
	...
	\item Certificate of my Bachelor's degree (2 page)
